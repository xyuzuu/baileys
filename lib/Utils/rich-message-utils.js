// big thanks to @Lia, Code from : https://github.com/itsliaaa/baileys/blob/main/lib/Utils/rich-message-utils.js
    ...
    if (Array.isArray(richResponse)) {
        ...
        if (links) {
            links.forEach((linkField, index) => {
                ...
                const url = linkField.url || 'https://wa.me';
...
export const wrapToBotForwardedMessage = (rich) => ({
    messageContextInfo: {
        botMetadata: {
